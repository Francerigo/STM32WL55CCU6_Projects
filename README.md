...
|-------------|------------------------------------------|-------------|
| **AT+TCONF** | `AT+TCONF=868000000:14:4:12:4/5:0:0:1:16:25000:2:3<CR>` | **Sintax**'AT+TCONF=<freq>:<pow>:<bw>:<sf>:<cr>:<lna>:<pa>:<mod>:<paylen>:<freqdev>:<lowdropt>:<BT><CR>' **Response:** `+TCONF: <mode>,<src>,<interval>` then `OK` |
